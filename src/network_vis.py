...
class VisNetwork():
    ...
    def grph_embd(self, similarity_threshold, src_path, papers):
        ...
        t4 = time.time()
        # Similarity
        print("Type of self.emb:", type(self.emb))
        print("Length of self.emb:", len(self.emb))
        print("Shape of each element in self.emb:", [np.shape(e) for e in self.emb])
...
def main():
    ...
    papers = ["1903.10174v1"] # "1706.03762", "1308.0850"]
    src_path = "data/article_pdf" # "data/article_pdf/txt/"

    papers = ["1706.03762", "1312.4400"]
