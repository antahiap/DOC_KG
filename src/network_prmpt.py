...
from constants import PAPER_PDF_PATH, OPEN_AI, OLLAMA, OLLAMA_URL, LLM_MODEL
...
class NetworkPrmpt():
    ...
    def _similaity_papers(self, n1, n2):
        ...
        if OPEN_AI:
            ...
            response = self.api.generate(model=LLM_MODEL, prompt=prompt)
...
if __name__ == '__main__':
    ...
    papers = [ "1706.03762.pdf"]#, "1312.4400", "1603.06147"]
